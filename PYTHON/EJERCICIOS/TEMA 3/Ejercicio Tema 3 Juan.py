...
for Line in GeneticCode: #Bucle used to split each line into the triplet and the coded aminoacid
    Data=Line.strip().split("\t")
    Code1[Data[0]]=Data[2] #Fill the dictionary with the two types of aminoacid nomenclature
    Code2[Data[0]]=Data[1]
GeneticCode.close() #Close file

reSeq=() #Open an empty string. We will put the RNA seq inside
Complement[] 
for x in [0,1,2]:
    Translate1_1=[]
    Translate1_2=[]
